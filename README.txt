...
1. Upload the Segenvita theme folder via FTP to your wp-content/themes/ directory. (The Genesis parent theme needs to be in the wp-content/themes/ directory as well.)
2. Go to your WordPress dashboard and select Appearance.
3. Activate the Segenvita theme.
...
The version of [Segenvita on GitHub](https://github.com/studiopress/genesis-sample/) includes tooling to check code against WordPress standards. To use it:
...
2. In the command line, change directory to the Segenvita folder.
...
You'll see output highlighting issues with PHP files that do not conform to Segenvita coding standards.
