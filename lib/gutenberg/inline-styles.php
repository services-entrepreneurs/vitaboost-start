 ...
 * @since 2.9.0
 */
function segenvita_custom_gutenberg_css() {
...
CSS;
	...
	$css .= segenvita_inline_font_sizes();
	$css .= segenvita_inline_color_palette();

	wp_add_inline_style( genesis_get_theme_handle() . '-gutenberg', $css );

}

add_action( 'enqueue_block_editor_assets', 'segenvita_custom_gutenberg_admin_css' );
/**
 ...
 * @since 2.9.0
 */
function segenvita_custom_gutenberg_admin_css() {
 ...
 */
function segenvita_inline_font_sizes() {
 ...
 */
function segenvita_inline_color_palette() {
